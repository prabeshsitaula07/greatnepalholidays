...
export const getActivities = (req: Request, res: Response) => {
  .query('SELECT * FROM activity', (err, results) => {
...
export const createActivity = (req: Request, res: Response) => {
  ...
  .query(query, [activity, place, price, country, imageurl, description], (err) => {
    if (err) return res.status(500).json({ error: err.message });
...
export const updateActivity = (req: Request, res: Response) => {
  ...
  .query(query, [activity, place, price, country, imageurl, description, id], (err) => {
    if (err) return res.status(500).json({ error: err.message });
