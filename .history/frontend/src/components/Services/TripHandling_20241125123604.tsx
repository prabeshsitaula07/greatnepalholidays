...
export default function TripHandling() {
    ...
    return (
      <div className="bg-primary h-fit flex justify-center flex-col items-center py-10 px-5 md:px-24">
          <h2 className="mb-10 text-4xl tracking-tight font-extrabold text-darkorange text-center font-parkinsans">We Will Handle Trip For You</h2>
          <div className="grid md:grid-cols-2 grid-c gap-8">
