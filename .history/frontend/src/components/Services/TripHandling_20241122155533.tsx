export default function TripHandling() {
    ...
    return (
      <div className="bg-primary h-fit flex justify-center flex-col items-center p-10">
          <h2 className="mb-10 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black text-center font-parkinsans">We Will Handle Trip For You</h2>
              ...
              {services.map((service, index) => (
                <div key={index} className="flex gap-10 items-center">
                  ...
                  <div>
                      ...
                      <p className="font-parkinsans">{service.description}</p>
                  </div>
                </div>
              ))}
          </div>
