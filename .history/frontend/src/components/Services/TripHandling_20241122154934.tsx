export default function TripHandling() {
    ...
    return (
      <div className="bg-primary h-fit flex justify-center flex-col items-center p-10">
          <h2 className="my-10 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black text-center">We Will Handle Trip For You</h2>
          <div className="grid grid-cols-2 gap-8">
              {services.map((service, index) => (
                <div key={index} className="flex gap-4 w-96">
