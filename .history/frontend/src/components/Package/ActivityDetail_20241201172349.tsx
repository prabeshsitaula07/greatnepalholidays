...
<div className='flex gap-2'>
                ...
                <div
                    className="mt-4 border shadow-md p-4 w-[80%]"
                    dangerouslySetInnerHTML={{ __html: activity.description }}
                />

                <form className="lg:w-1/3 md:w-[50%] bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0" onSubmit={handleSubmit}>
