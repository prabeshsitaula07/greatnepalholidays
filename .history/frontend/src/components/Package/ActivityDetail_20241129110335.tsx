...
const ActivityDetails = () => {
    ...
    <div className="absolute inset-0 bg-black bg-opacity-40"></div>
            <h3 className='absolute bottom-10 text-white px-5 py-10 md:px-24 flex items-center gap-4'><Link to='/activities'>Activities</Link><FontAwesomeIcon icon={faChevronRight} />{activity.activity}</h3>
            </div>
