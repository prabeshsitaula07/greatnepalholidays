    ...
    return (
        <div>
            <div className='relative'>
                ...
                />
                <div className="absolute inset-0 bg-black bg-opacity-40 px-5 md:px-24"></div>
                <h1 className='py-10'>{activity.activity}</h1>
                <h3 className='absolute bottom-10 text-white flex items-center gap-2'>
