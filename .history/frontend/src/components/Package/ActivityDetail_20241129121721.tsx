    ...
    return (
        <div>
            <div className='relative'>
                ...
                <h3 className='absolute bottom-10 text-white px-5 py-10 md:px-24 flex items-center gap-2'><Link to='/activities'>Activities</Link><FontAwesomeIcon icon={faChevronRight} />{activity.activity}</h3>
            </div>
            ...
            <div className="activity-description" dangerouslySetInnerHTML={{ __html: description }} />
        </div>
    );
};
