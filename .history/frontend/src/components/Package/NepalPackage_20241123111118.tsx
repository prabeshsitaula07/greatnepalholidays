export default function NepalPackage() {
  const packages = [
    ...
    { imgSrc: "https://cdn.pixabay.com/photo/2020/06/13/17/58/mount-everest-5295184_640.jpg", category: "CATEGORY", title: "Shooting Stars", price: "$21.15" },
  ];

  return (
    <section className="text-gray-600 body-font">
      <h2 className="mt-24 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black text-center">
        Best Selling Nepal Packages
      </h2>
      <h4 className="text-center text-xl text-darkorange font-semibold mt-2">
