export default function Activities() {
    ...
    return (
      <section className="text-gray-600 body-font">
        ...
        <button className="inline-flex items-center text-primary bg-darkorange border border-darkorange px-3 focus:outline-none hover:bg-primary text-lg hover:text-darkorange rounded-3xl md:mt-0">
                        See More
                    </button>
        </div>
