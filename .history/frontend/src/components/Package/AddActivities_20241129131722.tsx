    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} className="px-5 py-10 md:px-24">
                ...
                <button className="inline-flex items-center text-primary bg-darkorange border border-darkorange py-1 px-3 focus:outline-none hover:bg-primary text-lg hover:text-darkorange rounded my-4 md:mt-0" type='submit'>
                        Add Activity
                    </button>
            </form>
        </div>
