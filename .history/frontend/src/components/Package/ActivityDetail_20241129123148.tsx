    ...
    return (
        <div>
            ...
            <div className="container mx-auto p-5 px-5 py-10 md:px-24">
                ...
                <div className='bg-primary text-black p-4 rounded-lg shadow-lg'>
                    <h2 className='font-semibold text-3xl mb-4 text-center'>Trip Information</h2>

                    <div className='space-y-4'>
                        <div className='flex items-center space-x-3'>
                            <FaMapMarkerAlt className='text-xl text-darkorange' />
                            <div>
                        ...
                        <div className='flex items-center space-x-3'>
                            <FaDollarSign className='text-xl text-darkorange' />
                            <div>
                        ...
                        <div className='flex items-center space-x-3'>
                            <FaFlag className='text-2xl text-darkorange' />
                            <div>
                        ...
                        <div className='flex items-center space-x-3'>
                            <FaClock className='text-xl text-darkorange' />
                            <div>
