...
const AddInternationalPackage = () => {
    const [package_name, setInternationalPackage] = useState<string>('');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newInternationalPackage: InternationalPackage = {
            package_name,
            place,
        ...
        axios.post('http://localhost:5000/api/add-internationalpackage', newInternationalPackage)
            .then(response => {
                alert('Activity added successfully');
            })
            .catch(error => {
                console.error('There was an error adding the international package!', error);
            });
    };
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="px-5 py-10 md:px-24">
                <input
                    ...
                    value={package_name}
                    onChange={e => setInternationalPackage(e.target.value)}
...
export default AddInternationalPackage;
