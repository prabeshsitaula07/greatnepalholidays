    ...
    return (
        <div>
             <div className='relative'>
                <img
                    src={nepalpackage.image_url}
                    alt={internationalpackage.package_name}
                    className="w-screen max-h-[400px] object-cover"
                />
                <div className="absolute inset-0 bg-black bg-opacity-40"></div>
                <h3 className='absolute bottom-10 text-white px-5 py-10 md:px-24 flex items-center gap-2'><Link to='/activities'>Activities</Link><FontAwesomeIcon icon={faChevronRight} />{internationalpackage.package_name}</h3>
            </div>
