    ...
    return (
        <div>
             <div className='relative'>
                ...
                <h3 className='absolute bottom-10 text-white px-5 py-10 md:px-24 flex items-center gap-2'><Link to='/nepalpackages'>Activities</Link><FontAwesomeIcon icon={faChevronRight} />{nepalpackage.package_name}</h3>
            </div>
