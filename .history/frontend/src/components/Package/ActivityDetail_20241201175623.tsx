                ...
                <div className='md:flex gap-2'>
                    ...
                    <div className='md:w-1/2 lg:w-[20%] w-full pt-4'>
                        ...
                        <div className='bg-primary p-4'>
                            ...
                            <span className='font-bold' ></span><FontAwesomeIcon icon={faEnvelope}/> info@greatnepalholidays.com
                        </div>

                        <form className="bg-white flex flex-col md:ml-auto mt-8 md:mt-0" onSubmit={handleSubmit}>
