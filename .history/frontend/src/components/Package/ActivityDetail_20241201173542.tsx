...
<div className='md:flex gap-2'>
                ...
                <form className="lg:w-[20%] md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0" onSubmit={handleSubmit}>
                    ...
                    <div className="relative mb-4">
                        <label htmlFor="pnumber" className="leading-7 text-sm text-gray-600">Email</label>
                        <input type="number" id="pnumber" name="pnumber" className="w-full bg-white rounded border border-gray-300 focus:border-darkorange focus:ring-2 focus:ring-darkorange text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" value={email}
                            onChange={(e) => setEmail(e.target.value)} />
                    </div>
                    <div className="relative mb-4">
