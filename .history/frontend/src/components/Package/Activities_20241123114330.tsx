export default function Activities() {
  ...
  <button className="inline-flex items-center text-primary bg-darkorange border px-4 py-2 border-darkorange focus:outline-none hover:bg-primary text-base hover:text-darkorange rounded-3xl md:mt-0">
    See More
  </button>
</div>
