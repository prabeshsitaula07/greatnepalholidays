...
export default function Activities() {
    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="flex justify-between items-center px-5 py-10 md:px-20">
                <div>
                ...
                <button className="inline-flex items-center text-primary bg-darkorange border px-4 py-0 border-darkorange focus:outline-none hover:bg-primary text-lg hover:text-darkorange rounded-3xl h-10 md:mt-0">
                    See All Packages
                    <FaArrowRight className="ml-2 text-lg" />
                </button>
            </div>

            <div className="container px-5 py-10 mx-auto md:px">
