export default function NepalPackage() {
  ...
  return (
    <section className="text-gray-600 body-font">
      <h2 className="mt-24 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black text-center">Best Selling Nepal Packages</h2>
      <h4 className="text-center text-xl text-gray-500 mt-2">Enjoy the exclusive package tours with us.</h4>
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap -m-4">
          {packages.map((pkg, index) => (
            <div key={index} className="lg:w-1/4 md:w-1/2 m-4 w-full hover:cursor-pointer transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
