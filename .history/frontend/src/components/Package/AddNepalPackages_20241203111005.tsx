...
const AddNepalPackage = () => {
    const [nepalpackage, setNepalPackage] = useState<string>('');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const newNepalPackage: NepalPackage = {
            nepalpackage,
            place,
        ...
        axios.post('http://localhost:5000/api/add-nepalpackage', newNepalPackage)
            .then(response => {
                alert('Nepal Package added successfully');
            })
            .catch(error => {
                console.error('There was an error adding the nepal package!', error);
            });
    };
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} className="px-5 py-10 md:px-24">
                <input
                    ...
                    value={nepalpackage}
                    onChange={e => setNepalPackage(e.target.value)}
...
export default AddNepalPackage;
