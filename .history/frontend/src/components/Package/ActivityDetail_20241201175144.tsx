        ...
        <div>
            <div className='relative'>
                ...
                <h3 className='absolute bottom-10 text-white px-5 py-10 md:px-24 flex items-center gap-2'>
                    <Link to='/activities' className='hover:bg-darkorange duration-300 transition'>Activities</Link>
                ...
                <div className='md:flex gap-2'>
                    ...
                    <div className='md:w-1/2 lg:w-[20%] w-full pt-4'>
                        ...
                        <div className='bg-primary p-4'>
                            ...
                            Send us your question, feedback and support here: <br />
                        </div>

                        <form className="bg-white flex flex-col md:ml-auto md:pt-4 mt-8 md:mt-0" onSubmit={handleSubmit}>
