    ...
    return (
        <div>
            <div className='relative'>
                ...
                <h1 className='text-5xl font-extrabold'>{nepalpackage.package_name}</h1>
                <div className='flex items-center gap-2 pt-2 pb-10'>
                    <Link to='/activities' className='hover:text-darkorange duration-300 transition'>Nepal Packages</Link>
