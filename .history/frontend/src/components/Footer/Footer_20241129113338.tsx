            ...
            <div className="container px-5 py-24 md:px-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <Link to='/services' className="text-white hover:text-primary">Services</Link>
                            </li>
                            <li>
                                <Link to='/contact' className="text-white hover:text-primary">Contact</Link>
                            </li>
                            <li>
                                <Link to='/about/gallery' className="text-white hover:text-primary">Gallery</Link>
                            </li>
                            <li>
                                <Link to='/about/team' className="text-white hover:text-primary">Team Members</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        {activities.map((activity) => (
                                            <li key={activity.id} className="text-white hover:text-primary whitespace-nowrap">
                    ...
                    <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3"><Link to='/internationalpackages'>INTERNATIONAL PACKAGES</Link></h2>
                        ...
                        {internationalpackages.map((internationalpackage) => (
                                            <li key={internationalpackage.id} className="text-white hover:text-primary whitespace-nowrap">
                    ...
                    <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3"><Link to='/nepalpackages'>NEPAL PACKAGES</Link></h2>
                        ...
                        {nepalpackages.map((nepalpackage) => (
                                            <li key={nepalpackage.id} className="text-white hover:text-primary whitespace-nowrap font-normal">
