            ...
            <div className="container px-5 py-24 md:px-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                ...
                <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <Link to='/services' className="text-white hover:text-gray-800">Fourth Link</Link>
                            </li>
                            <li>
                                <Link to='/about/gallery' className="text-white hover:text-gray-800">Gallery</Link>
                            </li>
                            <li>
                                <Link to='/about/team' className="text-white hover:text-gray-800">Team</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">ACTIVITIES</h2>
                        <nav className="list-none mb-10">
