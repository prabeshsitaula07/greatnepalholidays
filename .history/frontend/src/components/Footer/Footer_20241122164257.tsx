    ...
    >
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                    <Link to='' className="flex title-font font-medium items-center md:justify-start justify-center text-">
                ...
                <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="title-font font-medium text- tracking-widest text-sm mb-3">CATEGORIES</h2>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Great Nepal Holidays —
                        <Link to='https://twitter.com/knyttneve' rel="noopener noreferrer" className="text-white ml-1" target="_blank">@knyttneve</Link>
                    </p>
