...
export default function Navbar() {
    ...
    return (
        <>
            ...
            >
                <div className="container mx-auto flex flex-wrap p-5 lg:px-24 justify-between items-center">
                    ...
                    <nav className='lg:hidden'>
                        <FiMenu size={30} />
                        {/* <FiX size={30} />   */}
                        <div className='bg-primary text-black absolute w-full left-0 top-full px-5 md:px-24'>
                        <Link to='' className="mr-5 hover:text-darkorange block p">Home</Link>
