                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-base">
                        ...
                        >
                            <Link to="/activities" className="hover:text-darkorange">
                                Activities <FontAwesomeIcon icon={faChevronDown} className="text-black hover:text-darkorange"  />
                            </Link>
                        ...
                        >
                            <Link to="/internationalpackages" className="hover:text-darkorange">
                                International Packages <FontAwesomeIcon icon={faChevronDown} className="text-black hover:text-darkorange"  />
                            </Link>
                                ...
                                >
                                    <ul>
                                        {internationalpackages.map((internationalpackage) => (
                                            <li key={internationalpackage.id} className="hover:text-darkorange py-1">
                        ...
                        >
                            <Link to="/nepalpackages" className="hover:text-darkorange">
                                Nepal Packages <FontAwesomeIcon icon={faChevronDown} className="text-black hover:text-darkorange" />
                            </Link>
