        ...
        <>
            ...
            >
                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center relative text-lg">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                    className="absolute -left-1/2 mt-2 w-screen bg-white text-black shadow-md rounded-md px-2 py-5 z-30"
