...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <header
                className={`text-black body-font w-full z-20 transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-primary shadow-md' : 'bg-[#2f3c5ae8] text-white'} flex`}
            >
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="hidden md:inline-flex md:ml-auto md:flex-wrap md:items-center justify-center text-base">
