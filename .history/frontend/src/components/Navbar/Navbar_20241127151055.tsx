                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-base">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                    className={`absolute left-0 top-full bg-primary text-black shadow-md p-4 z-30 mt-2 
          whitespace-nowrap w-fit transition-all duration-300 ease-in-out transform opacity-0 scale-95 ${isDropdownVisible ? 'opacity-100 scale-100' : ''
                                        }`}
