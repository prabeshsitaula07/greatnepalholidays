        ...
        <>
            ...
            >
                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                    className="absolute left-0 top-full bg-primary text-black shadow-md px-2 py-5 z-30 mt-8 whitespace-nowrap w-fit"
