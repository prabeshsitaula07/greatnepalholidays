...
export default function DownloadVisaCheckList() {
    ...
    return (
        <div className="fixed z-50 h-screen w-screen">
            ...
            <form className="bg-white flex flex-col md:ml-auto pt-4 mt-8 md:mt-0 absolute inset-0 m-auto w-full max-w-md h-auto rounded-lg shadow-lg z-50"
                onSubmit={handleSubmit}>
                <h2 className="text-darkorange px-4 py-2 text-lg mb-1 font-medium title-font">Quick Inquiry</h2>
