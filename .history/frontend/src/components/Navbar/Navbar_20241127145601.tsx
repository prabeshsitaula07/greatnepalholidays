...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <header
                className={`text-black relative  body-font w-full z-20 transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-primary shadow-md' : 'bg-[#2f3c5ae8] text-white'}`}
            >
                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-lg">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                    className="absolute left-0 top-full mt-2 bg-white text-black shadow-md rounded-md px-2 py-5 w-auto z-30"
