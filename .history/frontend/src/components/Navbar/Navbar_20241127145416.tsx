...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <header
                className={`text-black body-font relative w-full z-20 transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-primary shadow-md' : 'bg-[#2f3c5ae8] text-white'}`}
            >
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-lg">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                ...
                                {/* Parent container */}
                                <div
                                  className="absolute -bottom-0 -left-1/2 w-screen bg-white text-black shadow-md px-2 py-5 z-30"
                                  ...
                                  style={{
                                    left: '50%',
                                    transform: 'translateX(-50%)', // This centers the child element horizontally
                                    bottom: '0' // Align the child element's top with the parent's bottom
                                  }}
                                >
