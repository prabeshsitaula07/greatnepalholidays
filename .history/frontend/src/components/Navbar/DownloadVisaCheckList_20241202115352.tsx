...
export default function DownloadVisaCheckList() {
    ...
    return (
        <div className="fixed z-50 h-screen w-screen">
            ...
            <form className="bg-white flex flex-col md:ml-auto p-4 mt-8 md:mt-0 absolute inset-0 m-auto w-full max-w-md h-auto rounded-lg shadow-lg z-50"
                ...
                <div className="relative mb-4">
                    <label htmlFor="pnumber" className="leading-7 text-sm text-black">Number</label>
