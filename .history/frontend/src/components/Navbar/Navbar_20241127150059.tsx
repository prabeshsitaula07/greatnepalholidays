    ...
    return (
        <>
            ...
            >
                ...
                <div className="container relative mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-lg">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                    className="absolute left-0 top-full bg-primary text-black shadow-md px-2 py-5 w-auto z-30"
                                    style={{ top: '100%', left: '0' }}                                    onMouseEnter={handleListMouseEnter}  // Keep visible while hovering over the list
