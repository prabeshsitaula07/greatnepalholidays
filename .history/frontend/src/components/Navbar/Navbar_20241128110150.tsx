                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-base">
                        ...
                        >
                            ...
                            {dropdownVisibility.activities && (
                                <div
                                    className="absolute left-0 top-full bg-primary text-black shadow-md p-4 z-30 pt-2 lg:pt-8 whitespace-nowrap w-fit"
                        ...
                        >
                            ...
                            {dropdownVisibility.nepal && (
                                <div
                                    className="absolute left-0 top-full bg-primary text-black shadow-md p-4 z-30 mt-2 lg:pt-8 whitespace-nowrap w-fit"
