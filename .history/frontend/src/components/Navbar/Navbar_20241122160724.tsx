...
export default function Navbar() {
    ...
    return (
        <>
        <div className='w-full bg-darktheme flex gap-10'>
            <span className='text-white'>0988848484</span>
            <span className='text-white'>0988848484</span>
        </div>
        <header
            className={`text-black body-font fixed w-full z-20 transition-all duration-300 ${isScrolled ? 'top-0' : 'bg-primary' : 'bg-transparent'}`}
        >
