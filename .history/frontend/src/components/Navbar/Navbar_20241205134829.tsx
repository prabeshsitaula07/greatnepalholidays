...
export default function Navbar() {
    ...
    return (
        <>
            <div className='w-full bg-darkorange md:gap-10 md:flex px-5 py-2 lg:px-24 font-parkinsans'>
            ...
            <header
                className={`text-black body-font w-full z-20 transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-primary shadow-md' : 'bg-white text-black'}`}
            >
                <div className="w-full mx-auto container flex flex-wrap p-5 lg:px-24 justify-between items-center">
                    ...
                    <nav className="lg:inline-flex hidden lg:ml-auto lg:flex-wrap lg:items-center justify-center text-base">
                        <Link to='' className="mr-5 hover:text-darkorange" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Home</Link>
                        <Link to='' className="mr-5 hover:text-darkorange" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>About Us</Link>
                        <Link to='' className="mr-5 hover:text-darkorange onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}">Services</Link>
      ...
      {isMenuOpen && (
        <div className="bg-primary text-black absolute w-full left-0 z-30 px-5 lg:px-24 flex flex-col gap-2 py-4 mt-4">
          ...
          >
            ...
            {showChecklist && (
                <div className="bg-white rounded-lg shadow-lg relative" ref={checklistRef}>
                    <DownloadVisaCheckList />
                </div>
            )}
        </>
