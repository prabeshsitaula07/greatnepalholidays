            ...
            >
                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-base">
                        <Link to='' className="mr-5 hover:text-darkorange transition-all duration-300 ease-in-out">Home</Link>
                        <Link to='' className="mr-5 hover:text-darkorange transition-all duration-300 ease-in-out">About Us</Link>
                        <Link to='' className="mr-5 hover:text-darkorange transition-all duration-300 ease-in-out">Services</Link>
                        <Link to='' className="mr-5 hover:text-darkorange transition-all duration-300 ease-in-out">Packages</Link>
                        <div
                            className="relative mr-5"
                            onMouseEnter={handleMouseEnter}
                            onMouseLeave={handleMouseLeave}
                        >
                            <Link to="#" className="hover:text-darkorange transition-all duration-300 ease-in-out">Activities <FaCaretDown className="inline text-xl font-light" /></Link>
                            {isDropdownVisible && (
                                <div
                                    className="absolute left-0 top-full bg-primary text-black shadow-md p-4 z-30 mt-8 whitespace-nowrap w-fit transition-all duration-300 ease-in-out"
                                ...
                                >
                                    <ul>
                                        {activities.map((activity, id) => (
                                            <li key={id} className="hover:text-darkorange py-1 transition-all duration-300 ease-in-out">
