                ...
                <div className="container mx-auto flex flex-wrap p-5 md:px-24 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto flex flex-wrap items-center justify-center text-base">
                        ...
                        >
                            ...
                            {isDropdownVisible && (
                                <div
                                className={`absolute left-0 top-full bg-primary text-black shadow-md p-4 z-30 mt-8 whitespace-nowrap w-fit transition-all duration-200 ease-in-out transform ${
                                    isDropdownVisible ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
                                }`}
                            ...
                            >
                                <ul>
                                    {activities.map((activity, id) => (
                                        <li
                                            key={id}
                                            className="hover:text-darkorange py-1 transition-all duration-200 ease-in-out"
                                        >
