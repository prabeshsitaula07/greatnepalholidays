...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <header
                className={`text-black body-font w-full z-40 transition-all duration-300 ${isScrolled ? 'fixed top-0 bg-primary shadow-md' : 'bg-[#2f3c5ae8] text-white'}`}
            >
      ...
      {/* Dropdown Menu */}
      {isMenuOpen && (
        <div className="bg-primary text-black absolute w-full left-0 z-30 px-5 md:px-24 flex flex-col gap-2 py-4 pt-10">
