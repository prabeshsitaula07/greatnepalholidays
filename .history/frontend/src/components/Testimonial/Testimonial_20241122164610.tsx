export default function Testimonial() {
    ...
    return (
      <section className="bg-white dark:bg-gray-900 py-8 px-4 mx-auto max-w-screen-xl text-center">
        <h2 className="mb-4 text-4xl font-extrabold text-primary dark:text-white">Testimonials</h2>
        ...
        <div className="grid mb-8 lg:grid-cols-2">
          {testimonials.map(({ name, title, image, quote }, index) => (
            <figure key={index} className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 dark:bg-gray-800 dark:border-gray-700">
