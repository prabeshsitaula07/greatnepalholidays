export default function WhyChooseUs() {
  const features = [
    { title: "Seamless Experience", description: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nisi possimus repudiandae, sint cumque quas odio nam sdssd quo ab dasda asjbdia dfasbd?" },
