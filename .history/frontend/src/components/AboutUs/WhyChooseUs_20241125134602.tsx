...
export default function WhyChooseUs() {
  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="flex justify-center items-center px-5 py-10 md:px-24">
      ...
      <div className="container px-5 pb-10 mx-auto md:px-24">
        ...
        <p className='italic p-5 text-xl text-center'>Travel is not just about the destination,<br />it's about the journey we create together</p>
      </div>
    </section>
  );
}
