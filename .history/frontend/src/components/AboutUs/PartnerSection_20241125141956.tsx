    ...
    return (
        <section className="bg-primary py-16">
            <div className="container mx-auto px-5 md:px-24 flex">
                <div className='w-1/2'>
                <h2 className="text-4xl text-center tracking-tight font-extrabold text-gray-500 pb-4">Payment Partners</h2>
                ...
                <div className='h-full w-1 bg-darkorange'>

                </div>
                <div className='w-1/2'>
                <h2 className="text-4xl text-center tracking-tight font-extrabold text-gray-500 pb-4">Associated Organizations</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 w-full">
                        {/* Payment Partners */}
                        <div className="flex justify-center items-center">
                            <img
