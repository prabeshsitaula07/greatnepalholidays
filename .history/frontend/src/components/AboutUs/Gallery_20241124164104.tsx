...
export default function Gallery() {
 ...
 <h2 className="mt-10 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black text-center">Gallery</h2>
  <div className="container px-5 py-10 mx-auto flex flex-wrap md:px-24">
    ...
    <div className="flex flex-wrap md:-m-2 -m-1">
      ...
      <div className="flex flex-wrap w-1/2">
        <div className="md:p-2 p-1 w-full">
          <img alt="gallery" className="w-full h-full object-cover object-center block" src={gall} />
        </div>
        <div className="md:p-2 p-1 w-1/2">
