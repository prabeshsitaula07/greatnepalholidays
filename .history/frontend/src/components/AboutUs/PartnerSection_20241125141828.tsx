    ...
    return (
        <section className="bg-primary py-16">
            <div className="container mx-auto px-5 md:px-24 flex">
                <div className='w-1/2'>
                <h2 className="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black">Why Choose Us?</h2>
                ...
                <div className='w-1/2'>
                <h2 className="text-4xl tracking-tight font-extrabold text-gray-500 dark:text-black">Why Choose Us?</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 w-full">
                        {/* Payment Partners */}
                        <div className="flex justify-center items-center">
                            <img
