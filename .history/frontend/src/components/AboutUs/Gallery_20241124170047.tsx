      ...
      {isOpen && (
        ...
        >
          <div className="relative w-11/12 md:w-3/4 lg:w-1/2" onClick={(e) => e.stopPropagation()}>
            ...
            <button
  className="fixed top-4 right-4 text-black text-4xl font-bold hover:scale-110 transition-transform rounded-[100%] h-10 w-10 hover:border bg-transparent border-none shadow-lg"
  onClick={closeModal}
>
  X
</button>
