...
import member3 from '../../assets/member1.png';
import member4 from '../../assets/member1.png';
import member5 from '../../assets/member1.png';
import member6 from '../../assets/member1.png';
import member7 from '../../assets/member1.png';
            ...
            {[
              ...
              <div key={index} className="p-4 lg:w-1/4 md:w-1/2">
                <div className="h-full flex flex-col items-center text-center group relative">
                  <div className="w-full h-56 mb-4 overflow-hidden rounded-lg relative">
                    <img
                      alt="team"
