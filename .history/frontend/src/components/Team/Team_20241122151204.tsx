                ...
                <div className="h-full flex flex-col items-center text-center">
                  ...
                  <div className="w-full">
                    ...
                    <span className="inline-flex">
                      <a
                        className="text-darkorange transition-transform duration-300 hover:scale-110"
                      ...
                      <a
                        className="ml-2 text-darkorange transition-transform duration-300 hover:scale-110"
