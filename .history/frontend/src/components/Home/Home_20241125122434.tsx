...
{/* <img src={homebg} alt="" className='w-full object-cover h-full' /> */}
      ...
      <div className="relative z-10 flex items-center justify-center w-full h-full">
        <h1 className="text-white text-6xl font-bold text-center font-parkinsans absolute top-1/2"><span className='font-fira font-normal'>Time for your</span> <br />Next Adventure</h1>
      </div>
    </div>
      <Activities />
