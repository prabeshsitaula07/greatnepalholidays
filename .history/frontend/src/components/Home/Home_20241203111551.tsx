      ...
      <section className="relative min-h-screen w-full bg-cover bg-center" style={{ backgroundImage: `url(${homebg})` }}>
        ...
        <div className="relative z-10 text-white h-fit min-h-full mx-auto p-5 px-5 py-10 md:px-24">
          ...
          <div className='flex justify-between '>
            <div className=''>
              <p className='w-96'>Choose us for your Nepal tour for a personalized, seamless experience. With expert guides and custom itineraries, we ensure you explore Nepal's stunning landscapes, rich culture, and heritage with ease and comfort. Let us make your adventure unforgettable.</p>
              <Link to='/nepalpackages'>
                <button className="inline-flex items-center text-black bg-white border px-4 py-0 border-white focus:outline-none hover:bg-transparent text-lg hover:text-white rounded-xl h-10 mt-10 transition duration-300">
