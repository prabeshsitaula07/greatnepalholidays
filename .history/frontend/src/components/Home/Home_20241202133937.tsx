        ...
        <div className="relative z-10 text-white h-fit min-h-full mx-auto p-5 px-5 py-10 md:px-24">
          ...
          <div className='flex justify-between'>
            <div className=''>
              ...
              <button className="inline-flex items-center text-black bg-white border px-4 py-0 border-white focus:outline-none hover:bg-transparent text-lg hover:text-darkorange rounded-3xl h-10 md:mt-0 transition duration-300">
              See All Packages
              <FaArrowRight className="ml-2 text-lg" />
            </button>
               </div>
