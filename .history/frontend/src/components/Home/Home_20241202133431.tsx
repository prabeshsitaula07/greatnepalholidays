      ...
      <section className="relative h-screen w-full bg-cover bg-center" style={{ backgroundImage: `url(${homebg})` }}>
        ...
        <div className="relative z-10 text-white h-fit min-h-full mx-auto p-5 px-5 py-10 md:px-24">
          ...
          <div className='flex justify-between'>
            <div className=''>
              <p className='w-96'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus est nostrum modi sapiente, eligendi, corporis tempore earum deleniti dolorem temporibus ullam. Illum, dolorem.</p>
              <button className='mt-10 text-nowrap w-auto bg-white text-black px-4 py-2 font-bold rounded-lg hover:bg-transparent hover:text-white border border-white transition duration-150'><Link to='/nepalpackages'>See All <FaArrowRight /></Link></button>
            </div>
