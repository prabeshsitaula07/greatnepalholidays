...
{/* International Packages */}
  ...
  <div className="relative z-10 text-white h-fit min-h-full mx-auto p-5 px-5 py-10 md:px-24">
    ...
    <div className='flex'>
      <div className=''>
        <p className='w-'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus est nostrum modi sapiente, eligendi, corporis tempore earum deleniti dolorem temporibus ullam. Illum, dolorem.</p>
