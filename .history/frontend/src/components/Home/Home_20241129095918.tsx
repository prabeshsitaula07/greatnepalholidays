    ...
    <>
      <div className="relative w-full h-screen">
        ...
        <div className="relative z-10 flex items-center justify-center w-full h-full">
          <h1 className="text-white text-6xl font-bold text-center font-parkinsans absolute bottom-1/2"><span className='font-fira font-normal'>Time for your</span> <br />Next Adventure</h1><br />
          <h2 className='text-white text-4xl font-semibold font-fira pt-10'>Let us plan it for you</h2>
        </div>
      </div>
