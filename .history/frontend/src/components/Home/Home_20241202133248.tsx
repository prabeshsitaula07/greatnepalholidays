        ...
        <div className="relative z-10 text-white h-fit min-h-full mx-auto p-5 px-5 py-10 md:px-24">
          ...
          <div className='flex justify-between'>
            <div className=''>
              ...
              <button className='mt-10 bg-white text-black px-4 py-2 font-bold rounded-lg hover:bg-transparent hover:text-white border border-white transition du'><Link to='/nepalpackages'>See All</Link></button>
            </div>
